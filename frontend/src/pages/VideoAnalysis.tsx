...
import { ArrowLeft, Video as VideoIcon, Upload, Loader2, AlertCircle, X, Minus } from 'lucide-react';
import { Logo } from '../components/Logo';
import { Card } from '../components/Card';
import { Button } from '../components/Button';
import { useAuth } from '../contexts/AuthContext';
import { supabase } from '../lib/supabase';
import { analyzeVideo as analyzeVideoContent } from '../utils/mediaDetector';
...
export const VideoAnalysis = ({ onNavigate }: VideoAnalysisProps) => {
  ...
  const analyzeVideo = async () => {
    ...
    const analysisResult = analyzeVideoContent(file);
      ...
      <div className="max-w-5xl mx-auto px-6 py-12">
        <div className="mb-8">
          ...
          <p className="text-xl text-neutral-gray">
            Upload a video to analyze temporal patterns and estimate manipulation likelihood
          </p>
        </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-neutral-gray text-sm leading-relaxed">
                    This is a metadata-only demo estimate. Advanced deepfake detection requires backend processing
                    with frame-by-frame forensic analysis. This result should NOT be used for any serious verification.
                  </p>
                </div>
              </div>
            </Card>
